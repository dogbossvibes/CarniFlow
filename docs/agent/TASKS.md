...
- **T-58 — NEWBIE-Quota Production-Preflight (read-only)** · DONE(verified) — **Migration NICHT nötig**
  ...
  Freigabe ausführen. `20260808120000_..._one.sql` (→1) **nicht isoliert** anwenden (Regression 2→1). Premium
  (ACTIVE/FOUNDER/TRAINER/Lifetime) via `is_pro_member` unberührt; keine User-Daten betroffen. Verifikationsgrenze:
