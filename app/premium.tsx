...
const CARDS: CardDef[] = [
  { plan: 'beginner_trial', badge: 'Start', features: ['7 Tage kostenlos', 'Alle Active-Funktionen', 'Danach Active CHF 9.90/Mt.', 'Kein Trainerzugang'] },
  { plan: 'founder_active', badge: 'Nur 77×', founder: true, features: ['Dauerhaft CHF 7.90/Mt.', 'Solange das Abo aktiv bleibt', 'Alle Active-Funktionen', 'Kein Trainerzugang'] },
