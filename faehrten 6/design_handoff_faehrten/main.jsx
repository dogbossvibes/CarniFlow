  ...
  return (
    <React.Fragment>
      <DesignCanvas>
        ...
        <DCSection id="flow" title="Kompletter Flow" subtitle="Fährte legen → Liegezeit → Ausarbeiten → Auswertung → Logbuch">
          <DCArtboard id="legen" label="Fährte legen (live)" width={W} height={H} style={{ background: '#000' }}><Frame variant="Map" initial="legen" /></DCArtboard>
          <DCArtboard id="liegezeit" label="Liegezeit" width={W} height={H} style={{ background: '#000' }}><Frame variant="Map" initial="liegezeit" /></DCArtboard>
          <DCArtboard id="ausarbeiten" label="Ausarbeiten" width={W} height={H} style={{ background: '#000' }}><Frame variant="Map" initial="ausarbeiten" /></DCArtboard>
