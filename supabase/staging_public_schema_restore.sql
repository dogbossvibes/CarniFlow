...
CREATE OR REPLACE FUNCTION "public"."match_training_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "filter_user_id" "uuid", "filter_dog_id" "uuid" DEFAULT NULL::"uuid", "filter_category" "text" DEFAULT NULL::"text") RETURNS TABLE("id" "uuid", "training_session_id" "uuid", "source_type" "text", "content" "text", "content_summary" "text", "metadata" "jsonb", "similarity" double precision)
    LANGUAGE "sql" STABLE
    AS $$
  select
    te.id,
...
ALTER FUNCTION "public"."match_training_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "filter_user_id" "uuid", "filter_dog_id" "uuid", "filter_category" "text") OWNER TO "postgres";
...
CREATE INDEX "training_embeddings_embedding_idx" ON "public"."training_embeddings" USING "ivfflat" ("embedding" "extensions"."vector_cosine_ops") WITH ("lists"='100');
...
GRANT ALL ON FUNCTION "public"."match_training_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "filter_user_id" "uuid", "filter_dog_id" "uuid", "filter_category" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."match_training_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "filter_user_id" "uuid", "filter_dog_id" "uuid", "filter_category" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_training_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "filter_user_id" "uuid", "filter_dog_id" "uuid", "filter_category" "text") TO "service_role";
