...
describe('medianLatLng (Startanker)', () => {
  ...
  it('ist robust gegen einen einzelnen Drift-Ausreisser (Median statt Mittelwert)', () => {
    // Vier eng beieinander + ein grober Ausreisser → Median bleibt bei der Wolke.
    const m = medianLatLng([
    ...
    // Median (mittlerer von 5) → 47.102/8.102, NICHT vom Ausreisser mitgezogen.
